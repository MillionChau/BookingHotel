...
import './Footer.css'; // Import file CSS để tạo kiểu
    ...
    <footer className="footer-container">
      ...
      <div className="footer-links-grid">
        <div className="footer-column">
          <h3>Hỗ trợ</h3>
          <ul>
            <li><a href="#">Các câu hỏi thường gặp về virus corona (COVID-19)</a></li>
        ...
        <div className="footer-column">
          ...
          <ul>
            ...
            <li><a href="#">Các loại chỗ nghỉ</a></li>
            <li><a href="#">Đánh giá</a></li>
            <li><a href="#">Ưu đãi theo mùa và dịp lễ</a></li>
            <li><a href="#">Bài viết về du lịch</a></li>
            <li><a href="#">BookingHotel.com dành cho Doanh Nghiệp</a></li>
        ...
        <div className="footer-column">
          ...
          <ul>
            ...
            <li><a href="#">Đăng ký chỗ nghỉ của Quý vị</a></li>
      ...
      <div className="footer-legal-info">
        ...
        <p>Booking.com là một phần của Booking Hotel Inc., tập đoàn đứng đầu thế giới về du lịch trực tuyến và các dịch vụ liên quan.</p>
